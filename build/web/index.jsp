            ...
            <section id="about" class="row tm-section">
              <div class="col-xl-6">
                <div class="tm-section-half">    
                    ...
                    <p>
                       However, it sometimes refers to a collection center, and some hospitals also perform collection. Blood banking includes tasks related to blood collection, processing, testing, separation, and storage.
                    </p>
                </div>
              </div>
              <div class="col-xl-6">
                <div class="tm-section-half">
                    ...
                    <p class="mb-5">
                      We are helping people in need of blood in Delhi since 2004 and helped nearly 3 lakh people
                      all over country.WE urge to all of them who are visiting our website to donate blood so that
                      the needy can be helped.
                    </p>
                    <p>
                      More than 2 lakh people have donated the blood to our company.Then to
                      their is shortage of 1 lakh units of blood for 
                      patients in Delhi.Thus we will be grateful to you for your help. 
                    </p>
                </div>
              </div>
            </section>
